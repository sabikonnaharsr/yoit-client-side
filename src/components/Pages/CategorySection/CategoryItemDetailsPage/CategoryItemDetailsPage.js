...
const CategoryItemDetailsPage = () => {
  ...
  const handleWishlist = (product) => {
    ...
    fetch("https://byte-code-velocity.vercel.app/wishlist", {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      ...
      <p className="text-2xl text-center text-cyan-500 hover:text-pink-600">
        100% Cotton Made in Italy Designer Model Number: DS01B7527MAC Designer
        Color: 53
      </p>
    ...
    <div className="px-4 py-16 mx-auto shadow-2xl sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            ...
            <div className="max-w-xl mb-6">
              <div className="flex justify-between items-center">
                ...
                <div className="flex text-2xl btn btn-ghost mb-3 ">
                  ...
                  <div>
                    <label
                      onClick={() => setBooking(detailsProduct)}
                      htmlFor="booking-modal"
                      className="text-2xl btn btn-ghost mb-3 "
                    >
                      <FaPlus></FaPlus>
                    </label>
                  </div>
              ...
              <p className="text-base uppercase text-gray-700">{description}</p>
      ...
      <div>{<BookingModal booking={booking}></BookingModal>}</div>
    </div>
  );
};
