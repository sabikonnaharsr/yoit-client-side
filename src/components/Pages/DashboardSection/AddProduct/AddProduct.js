    ...
    fetch(
      ...
      .then((imgData) => {
        if (imgData.success) {
          ...
          fetch("https://byte-code-velocity.vercel.app/addProduct", {
            method: "POST",
            headers: {
        ...
        >
          Welcome to add your products 
              ...
              <p className="mt-4 leading-relaxed text-gray-500">
                Thank your being with us and also we are here to give you the
                best price.
              </p>
              ...
              >
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  <button className="inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-slate-50 transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
                    Add Product
                  </button>
