...
const Card = () => {
    return (
        <div className='grid gap-4 mb-4 xm:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 mx-auto items-center justify-center'>
                 <div className="rounded-md shadow-md sm:w-96 dark:bg-gray-900 dark:text-gray-100">
	<div className="flex items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			<img src="https://img.freepik.com/premium-photo/happy-smiling-cute-little-girl-yellow-dress-hat-walks-field-summer-outdoor-lifestyle_445701-645.jpg?w=996" alt="" className="object-cover object-center w-8 h-8 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-700" />
	...
	<img src="https://img.freepik.com/premium-photo/happy-smiling-cute-little-girl-yellow-dress-hat-walks-field-summer-outdoor-lifestyle_445701-645.jpg?w=996" />
	<div className="p-3">
